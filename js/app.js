(() => {
        ...
        return function n(r, o) {
            function i(e, n, i) {
                if ("undefined" != typeof document) {
                    ...
                    i.expires && (i.expires = i.expires.toUTCString()), n = r.write(n, e), e = encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g, decodeURIComponent).replace(/[()]/g, escape);
                    var c = "";
    ...
    const cookieOk = document.querySelector(".cookie__btn");
    let cookies = () => {
        if (!Cookies.get("hide-cookie")) setTimeout((() => {
            cookieElement.style.bottom = "0";
            cookieOk.addEventListener("click", (e => {
                cookieElement.style.bottom = "-100%";
